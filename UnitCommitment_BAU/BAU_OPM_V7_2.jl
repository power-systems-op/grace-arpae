   ...
   fucr_prep_demand = DemandPreprocGens(
    ...
    for h=1:INIT_HR_SUCR-INIT_HR_FUCR # number of BUCR periods in between FUCR and SUCR
        ...
        for g=1:GENS
            ...
            if FUCRtoBUCR1.gens.onoff[g,h]==0
    ...
    # Constraints representing technical limits of conventional generators
        ...
        @constraint(BUCR1model, conStorgChrgStatusFixed[p=1:STORG_UNITS], (BUCR1_storgChrg[p]==FUCRtoBUCR1.storg.chrg[p,h]))
        @constraint(BUCR1model, conStorgDisChrgStatusFixed[p=1:STORG_UNITS], (BUCR1_storgDisc[p]==FUCRtoBUCR1.storg.disc[p,h]))
        @constraint(BUCR1model, conStorgIdleStatusFixed[p=1:STORG_UNITS], (BUCR1_storgIdle[p]==FUCRtoBUCR1.storg.idle[p,h]))
