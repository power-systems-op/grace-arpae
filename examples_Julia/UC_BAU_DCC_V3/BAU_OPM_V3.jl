...
FUCR_Demands = XLSX.readdata(".\\IInputs\\data_demand.XLSX", "data_demand", "D2:E54000")
SUCR_Demands = XLSX.readdata(".\\IInputs\\data_demand.XLSX", "data_demand_updated", "D2:E54000")
BUCR_Demands = XLSX.readdata(".\\IInputs\\data_demand.XLSX", "data_demand_actual", "C2:D7729")
...
FUCR_SolarGs = XLSX.readdata(".\\IInputs\\data_solar.XLSX", "data_solar", "C2:D7729")
SUCR_SolarGs = XLSX.readdata(".\\IInputs\\data_solar.XLSX", "data_solar_updated", "C2:D7729")
BUCR_SolarGs = XLSX.readdata(".\\IInputs\\data_solar.XLSX", "data_solar_actual", "C2:D7729")

# wind energy data for each location
FUCR_WindGs = XLSX.readdata(".\\IInputs\\data_wind.XLSX", "data_wind", "C2:D7729")
SUCR_WindGs = XLSX.readdata(".\\IInputs\\data_wind.XLSX", "data_wind_updated", "C2:D7729")
BUCR_WindGs = XLSX.readdata(".\\IInputs\\data_wind.XLSX", "data_wind_actual", "C2:D7729")

#hydro generation data for each location
FUCR_HydroGs = XLSX.readdata(".\\IInputs\\data_hydro.XLSX", "data_hydro", "B2:C7729")
SUCR_HydroGs = XLSX.readdata(".\\IInputs\\data_hydro.XLSX", "data_hydro_updated", "B2:C7729")
BUCR_HydroGs = XLSX.readdata(".\\IInputs\\data_hydro.XLSX", "data_hydro_actual", "B2:C7729")

#Zonal Reserve Targets
Reserve_Req_Up = XLSX.readdata(".\\IInputs\\data_reserve_reqs.XLSX", "data_reserve_reqs", "A2:B2")

# Transmission system data (Capacity and Susceptance)
TranC = XLSX.readdata(".\\IInputs\\data_transmission.XLSX", "LineCapacity","B2:C3") # Transmission line capacity
TranS = XLSX.readdata(".\\IInputs\\data_transmission.XLSX", "LineSusceptance","B2:C3")# Transmission line susceptance

# Daily Fuel Price data
FuelPrice = XLSX.readdata(".\\IInputs\\data_generators.XLSX", "data_fuel_price", "D3:ND134")
...
## This block models the first UC optimization that is run in the morning
    ...
    set_optimizer_attribute(FUCRmodel, "CPX_PARAM_EPGAP", 0.0004)
...
## This block models the second UC optimization that is run in the evening
    ...
    set_optimizer_attribute(SUCRmodel, "CPX_PARAM_EPGAP", 0.0004)
